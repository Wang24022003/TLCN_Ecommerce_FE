                ...
                <div className='bg-[#6f68d1] p-4 rounded-md'>
                    ...
                    <form onSubmit={submit}>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            type="name" name='name' placeholder='Name' id='name' required/>
                        </div>
                        ...
                        <div className='flex items-center w-full gap-3 mb-3'>
                            <input className='w-4 h-4 text-blue-600 overflow-hidden bg-gray-200 border-gray-300 focus:ring-blue-500'
